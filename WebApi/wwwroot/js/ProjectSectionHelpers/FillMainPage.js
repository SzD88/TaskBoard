...
async function fillMainPage(sortingAttribute, ascending) {

   

    var projects_content_list = await getAllProjectsSortedByAttribute(sortingAttribute, ascending); // ascending - false
...
async function clearProjectsList() {
